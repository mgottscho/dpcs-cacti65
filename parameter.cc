...
void TechnologyParameter::DeviceType::display(uint32_t indent)
{
  ...
  cout << indent_str << "R_nch_on  = " << setw(12) << R_nch_on  << " ohm-um" << setw(12) << "(nominal " << nominal_R_nch_on << " ohm-um)" << endl; //DPCS
  cout << indent_str << "R_pch_on  = " << setw(12) << R_pch_on  << " ohm-um" << setw(12) << "(nominal " << nominal_R_pch_on << " ohm-um)" << endl; //DPCS
  cout << indent_str << "Vdd  = " << setw(12) << Vdd  << " V" << setw(12) << "(nominal " << nominal_Vdd << " V)" << endl; //DPCS
  cout << indent_str << "Vth       = " << setw(12) << Vth       << " V" << endl;
  cout << indent_str << "Vdsat       = " << setw(12) << nominal_Vdsat       << " V" << endl;
  cout << indent_str << "I_on_n	  = " << setw(12) << I_on_n  << " A/um" << setw(12) << "(nominal " << nominal_I_on_n << " A/um)" << endl; //DPCS
  cout << indent_str << "I_on_p	  = " << setw(12) << I_on_p  << " A/um" << setw(12) << "(nominal " << nominal_I_on_p << " A/um)" << endl; //DPCS
  cout << indent_str << "I_off_n	  = " << setw(12) << I_off_n  << " A/um" << setw(12) << "(nominal " << nominal_I_off_n << " A/um)" << endl; //DPCS
  cout << indent_str << "I_off_p	  = " << setw(12) << I_off_p  << " A/um" << setw(12) << "(nominal " << nominal_I_off_p << " A/um)" << endl; //DPCS
